...
-- Volcando estructura de base de datos para dbbienestar
CREATE DATABASE IF NOT EXISTS `dbbienestar` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `dbbienestar`;

-- Volcando estructura para tabla dbbienestar.admins
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla dbbienestar.alumnos
CREATE TABLE IF NOT EXISTS `alumnos` (
  ...
  KEY `fk_Estudiantes_CarrerasProfesionals_idx` (`idCarreraProfesional`),
  CONSTRAINT `fk_Estudiantes_CarrerasProfesionals` FOREIGN KEY (`idCarreraProfesional`) REFERENCES `carreraprofesionals` (`idCarreraProfesional`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla dbbienestar.carreraprofesionals
CREATE TABLE IF NOT EXISTS `carreraprofesionals` (
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla dbbienestar.migrations
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla dbbienestar.operacionbienestars
CREATE TABLE IF NOT EXISTS `operacionbienestars` (
  `idOperacionBienestar` int(11) NOT NULL AUTO_INCREMENT,
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla dbbienestar.operacionestudiante
CREATE TABLE IF NOT EXISTS `operacionestudiante` (
  `idOperacionEstudiante` int(11) NOT NULL AUTO_INCREMENT,
  `idAlumno` int(11) NOT NULL,
  `idOperacionBienestar` int(11) NOT NULL,
  `fecha` date DEFAULT NULL,
  `observaciones` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idOperacionEstudiante`,`idAlumno`,`idOperacionBienestar`),
  KEY `fk_Estudiantes_has_OperacionBienestars_OperacionBienestars1_idx` (`idOperacionBienestar`),
  KEY `fk_Estudiantes_has_OperacionBienestars_Estudiantes1_idx` (`idAlumno`),
  CONSTRAINT `fk_Estudiantes_has_OperacionBienestars_Estudiantes1` FOREIGN KEY (`idAlumno`) REFERENCES `alumnos` (`idAlumno`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Estudiantes_has_OperacionBienestars_OperacionBienestars1` FOREIGN KEY (`idOperacionBienestar`) REFERENCES `operacionbienestars` (`idOperacionBienestar`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla dbbienestar.password_resets
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla dbbienestar.users
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla dbbienestar.usuarios
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla dbbienestar.usuarios_copy1
CREATE TABLE IF NOT EXISTS `usuarios_copy1` (
...
-- Volcando estructura para tabla mydb.administrador
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla mydb.alumnos
CREATE TABLE IF NOT EXISTS `alumnos` (
  `idAlumno` int(11) NOT NULL AUTO_INCREMENT,
  `dni` varchar(8) DEFAULT NULL,
  `nombre` varchar(25) DEFAULT NULL,
  ...
  PRIMARY KEY (`idAlumno`),
  KEY `fk_Estudiantes_CarrerasProfesionals_idx` (`idCarreraProfesional`),
  CONSTRAINT `fk_Estudiantes_CarrerasProfesionals` FOREIGN KEY (`idCarreraProfesional`) REFERENCES `carrerasprofesionals` (`idCarreraProfesional`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla mydb.carrerasprofesionals
CREATE TABLE IF NOT EXISTS `carrerasprofesionals` (
  `idCarreraProfesional` int(11) NOT NULL AUTO_INCREMENT,
  `nombreCarrera` varchar(45) DEFAULT NULL,
  `observaciones` varchar(45) DEFAULT NULL,
  `created_at` varchar(45) DEFAULT NULL,
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla mydb.operacionbienestars
CREATE TABLE IF NOT EXISTS `operacionbienestars` (
  `idOperacionBienestar` int(11) NOT NULL AUTO_INCREMENT,
  `nombreOperacion` varchar(45) DEFAULT NULL,
  `observaciones` varchar(45) DEFAULT NULL,
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla mydb.operacionestudiante
CREATE TABLE IF NOT EXISTS `operacionestudiante` (
  `idOperacionEstudiante` int(11) NOT NULL AUTO_INCREMENT,
  `idAlumno` int(11) NOT NULL,
  `idOperacionBienestar` int(11) NOT NULL,
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla mydb.usuarios_copy1
CREATE TABLE IF NOT EXISTS `usuarios_copy1` (
  `idUsuarios` int(11) NOT NULL AUTO_INCREMENT,
  `dni` varchar(8) DEFAULT NULL,
  `nombre` varchar(25) DEFAULT NULL,
...
-- Volcando estructura de base de datos para myproject
CREATE DATABASE IF NOT EXISTS `myproject` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `myproject`;

-- Volcando estructura para tabla myproject.faker
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla myproject.migrations
CREATE TABLE IF NOT EXISTS `migrations` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `migration` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `batch` int(11) NOT NULL,
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla myproject.password_resets
CREATE TABLE IF NOT EXISTS `password_resets` (
  `email` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `token` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla myproject.prioridades
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla myproject.tareas
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla myproject.users
CREATE TABLE IF NOT EXISTS `users` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
